...
namespace Self_Eater_Snake.GameBasic
{
    ...
    abstract internal class BeginOrEndBasic : ISceneUpdate
    {
        ...
        public void Update()
        {
            ...
            //打印标题
            Console.SetCursorPosition(Game.width/2 - title.Length/2,Game.height - 15);
            Console.Write(title);
            //打印副标题
            Console.SetCursorPosition(Game.width / 2 - subtitle.Length, Game.height - 14);
            Console.Write(subtitle);
            //打印第一个选项
            Console.SetCursorPosition(Game.width/2 - option1.Length, Game.height - 10);
            Console.ForegroundColor = (nowSelect == 0 ? ConsoleColor.Red : ConsoleColor.White);
            Console.Write(option1);
            //打印第二个选项
            Console.SetCursorPosition(Game.width/2 - 4, Game.height - 9);
